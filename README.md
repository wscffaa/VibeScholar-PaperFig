...
1. You define logical structure in `layout.json` (grid positions, element types, connections)
...
4. You do final touch-up on connection routing in draw.io GUI (~30 seconds)
